            ...
            <div className="flex-1 overflow-hidden flex flex-col bg-[#F2F2F7]">
               <div className="flex-1 overflow-y-auto p-6 space-y-8 pb-32">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex bg-white p-1.5 rounded-2xl border border-black/5 shadow-sm">
                       <button 
                         ...
                         className={cn("flex-1 py-3 font-black text-xs rounded-xl transition-all", paymentStatus === 'UNPAID' ? "bg-expense text-white shadow-lg" : "text-black/30")}
                       >
                         UNPAID
                       </button>
                       <button 
                         onClick={() => setPaymentStatus('PAID')}
                         className={cn("flex-1 py-3 font-black text-xs rounded-xl transition-all", paymentStatus === 'PAID' ? "bg-ios-blue text-white shadow-lg" : "text-black/30")}
                       >
                         PAID
                       </button>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                       <input
                        ...
                        className="w-full bg-white border border-black/5 rounded-2xl p-5 font-bold text-sm outline-none shadow-sm"
                      />
                      <input
                        type="text"
                        value={customerPhone}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      {items.map((item) => (
                        <div key={item.id} className="p-5 bg-white rounded-3xl border border-black/5 shadow-sm space-y-4 relative group">
                            <button 
                  ...
                  >
                        ...
                        <div className="relative">
                           {paymentStatus === 'PAID' && (
                              <div className="absolute inset-x-0 inset-y-[-20%] flex items-center justify-center pointer-events-none z-10 select-none overflow-hidden">
                                 <div 
                                    className="border-[6px] border-[#2563EB]/70 text-[#2563EB]/80 p-6 rounded-full flex flex-col items-center justify-center rotate-[-12deg] ring-4 ring-[#2563EB]/5 bg-white/10 backdrop-blur-[1px] shadow-2xl scale-125"
                                    style={{
                    ...
                    {style === 'PREMIUM' && (
                       <div className="p-10 text-black bg-white min-h-full flex flex-col relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-[#36A893]/5 rounded-bl-[100%] z-0" />
                        
                        <div className="flex justify-between items-start mb-16 border-t-[10px] border-[#36A893] pt-10 relative z-10">
                            <div className="flex items-center gap-4">
                              <div className="w-16 h-16 bg-[#36A893] rounded-[24px] flex items-center justify-center text-white font-black text-3xl shadow-2xl shadow-[#36A893]/30">CF</div>
