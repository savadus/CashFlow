      ...
      >
        ...
        <div className="bg-white border-b border-black/5 px-6 py-6 flex items-center justify-between sticky top-0 z-10 shadow-sm">
          <div className="flex items-center gap-4">
            <div className={cn("w-12 h-12 rounded-2xl flex items-center justify-center", info.bg)}>
          ...
          <button 
            onClick={onClose}
            className="w-12 h-12 bg-black/5 rounded-full flex items-center justify-center active:scale-90 transition-transform"
          >
        ...
        <div className="flex-1 overflow-y-auto">
           ...
           <div className="bg-white px-6 py-8 border-b border-black/5 mb-4 flex items-center justify-between">
              ...
              <div className="w-12 h-12 rounded-full border-2 border-black/5 flex items-center justify-center opacity-20">
