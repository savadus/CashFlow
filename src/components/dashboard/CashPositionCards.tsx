  ...
  return (
    <div className="px-6 mb-12">
      <div className="flex items-center gap-3 mb-8">
        <div className="w-1.5 h-6 bg-foreground rounded-[10px]" />
        <h3 className="text-xs font-black  tracking-tight text-text-dim italic">Where is Cash?</h3>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <motion.div 
          whileHover={{ y: -5 }}
          className="bg-card border border-card-border p-4 rounded-[10px] shadow-sm flex flex-col items-center text-center group active:scale-95 transition-all"
        >
          <div className="w-12 h-12 rounded-[10px] bg-emerald-500/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
        ...
        <motion.button 
          ...
          className="bg-card border border-card-border p-4 rounded-[10px] shadow-sm flex flex-col items-center text-center group active:scale-95 transition-all"
        >
          <div className="w-12 h-12 rounded-[10px] bg-blue-500/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
        ...
        <motion.button 
          ...
          className="bg-card border border-card-border p-4 rounded-[10px] shadow-sm flex flex-col items-center text-center group active:scale-95 transition-all"
        >
          <div className="w-12 h-12 rounded-[10px] bg-rose-500/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
        ...
        {isBanksModalOpen && (
          <>
            ...
            <motion.div 
               ...
               className="fixed left-6 right-6 top-1/2 -translate-y-1/2 bg-background border border-card-border rounded-[10px] z-[401] overflow-hidden shadow-2xl"
            >
               <div className="p-8 border-b border-card-border flex items-center justify-between">
                  <div className="flex items-center gap-4">
                     <div className="w-12 h-12 bg-blue-500 text-white rounded-[10px] flex items-center justify-center">
                  ...
                  <button onClick={() => setIsBanksModalOpen(false)} className="p-3 bg-secondary rounded-[10px] hover:bg-tertiary transition-colors">
               ...
               <div className="p-4 max-h-[60vh] overflow-y-auto">
                  <div className="grid grid-cols-1 gap-3">
                     {banks.map(bank => (
                        <div key={bank.id} className="bg-secondary p-8 rounded-[10px] border border-card-border flex items-center justify-between group hover:bg-tertiary transition-all">
                           <div className="flex items-center gap-6">
                              <div className="w-12 h-12 bg-blue-500/10 rounded-[10px] flex items-center justify-center group-hover:scale-110 transition-transform">
