...
export const ProfileModal = ({ isOpen, onClose }: ProfileModalProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-black px-6 py-8 pb-10 relative overflow-hidden shrink-0">
        ...
        <div className="flex items-center justify-between text-white relative z-10">
          <div className="flex items-center gap-4">
            <button 
              onClick={onClose}
              className="p-2.5 bg-white/10 backdrop-blur-xl rounded-[10px] hover:bg-white/20 transition-all border border-white/10"
            >
      ...
      <div className="flex-1 overflow-y-auto px-6 py-8 -mt-6 bg-background rounded-[10px]-[32px] shadow-2xl relative z-10 scroll-smooth pb-32">
        <div className="max-w-md mx-auto space-y-8">
          
          {/* Profile Image Section */}
          <section className="flex flex-col items-center">
             <div className="relative group">
                <div className="w-24 h-24 rounded-[10px] bg-secondary border-2 border-card-border overflow-hidden shadow-xl">
                   {userImage ? (
                ...
                <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-black text-white rounded-[10px] flex items-center justify-center shadow-xl border-2 border-background">
             ...
             <div className="w-full mt-6">
                ...
                <input 
                  ...
                  className="w-full bg-secondary border border-card-border rounded-[10px] p-4 font-bold text-[10px] outline-none focus:border-foreground transition-all text-foreground"
                />
             </div>
          </section>
          ...
          <section>
             ...
             <div>
                ...
                <input 
                  ...
                  className="w-full bg-black text-white rounded-[10px] p-4.5 font-bold text-xs tracking-tight outline-none shadow-xl "
                />
             </div>
          </section>
          ...
          <section>
             <div className="flex items-center justify-between mb-4">
                ...
                <button 
                  ...
                  className="p-1.5 bg-secondary rounded-[10px] hover:bg-tertiary transition-all border border-card-border text-foreground"
                >
                     ...
                     <div className="relative flex items-center gap-2">
                        <div className="relative flex-1">
                           ...
                           <input 
                              ...
                              className="w-full bg-secondary border border-card-border rounded-[10px] p-3.5 pl-11 font-bold text-[10px] outline-none focus:border-foreground transition-all  tracking-tight text-foreground placeholder:text-black/10"
                           />
                        </div>
                        <button 
                          onClick={() => handleRemoveBank(bank.id)}
                          className="p-3 bg-expense/5 text-expense rounded-[10px] hover:bg-expense/10 transition-all border border-expense/10"
                        >
          ...
          <div className="pt-6">
             <button 
               ...
               disabled={isSaved}
               className={cn(
                 "w-full p-4.5 rounded-[10px] font-bold text-[10px]  tracking-tight flex items-center justify-center gap-3 shadow-xl transition-all active:scale-95",
